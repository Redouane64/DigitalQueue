...
public class FindCourseByTitleQueryHandler : IRequestHandler<FindCourseByTitleQuery, CourseDto?>
{
    private readonly DigitalQueueContext _context;

    public FindCourseByTitleQueryHandler(DigitalQueueContext context)
    {
        _context = context;
    }
